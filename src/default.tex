%%% ADDITIONAL NOTES
%%% CONSIDER (to modify environments)
% \usepackage{etoolbox}
...
%%% THIS DOCUMENT WAS GENERATED ON 2024-02-23
%%% THIS DOCUMENT MAY BE RE-GENERATED WITH THE COMMAND (LINUX):
%%% pandoc -D latex > src/default.tex
%%% THIS MESSAGE MUST BE MANUALLY RE-INSERTED WHEN THIS DOCUMENT IS RE-GENERATED
